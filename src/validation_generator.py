...
class BaseValidator(ABC):  # Abstraction
    ...
    def generate_validation(self, toc_data: List[Any], 
                          spec_data: List[Any]) -> Path:
        pass


class XLSValidator(BaseValidator):  # Inheritance
    def generate_validation(self, toc_data: List[Any], 
                          spec_data: List[Any]) -> Path:  # Polymorphism
    ...
    def _create_summary_sheet(self, ws: Any, toc_data: List[Any], 
                            spec_data: List[Any]) -> None:  # Encapsulation
        # Headers
    ...
    def _create_comparison_sheet(self, ws: Any, toc_data: List[Any], 
                               spec_data: List[Any]) -> None:  # Encapsulation
        # Headers
...
def create_validation_report(output_dir: Path, toc_file: Path, 
                           spec_file: Path) -> Path:
