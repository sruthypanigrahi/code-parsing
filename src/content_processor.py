...
class ContentProcessor:
    ...
    def process_structured_content(self, content_iterator: Iterator[Dict[str, Any]]) -> Iterator[Dict[str, Any]]:
    ...
    def save_content(self, content_iterator: Iterator[Dict[str, Any]], output_path: Path) -> int:
